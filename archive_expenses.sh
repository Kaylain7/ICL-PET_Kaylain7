...
# archive_expenses.sh
# Usage:
# ./archive_expenses.sh archive expenses_2024-11-07.txt # move file to archives/ and log
# ./archive_expenses.sh search 2024-11-07 # print archived file for that date
